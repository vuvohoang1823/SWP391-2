    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         CustomerDAO customerdao = new CustomerDAO();
          ...
          int customerID = customerdao.getCustomerID(user.getUser_id());
            if (address == null || trainer == null || datestart == null || note == null || type == null) {
        ...
        // For example, you could assign a default value or show an error message
             System.out.println("Error message with NumberFormatException");
                ...
                int trainerIDInt = 0 ;
                 if(!selectedTrainerID.isEmpty()){
               trainerIDInt = Integer.parseInt(selectedTrainerID); // Convert the trainerID string to int
                 }else{
                // Handle the case when userID is empty
        // For example, you could assign a default value or show an error message
             System.out.println("Error message with NumberFormatException");
...
//       }
         ...
         dao.InputFormAppointment(consultationID, trainerIDInt, customerID, datestartSql, note, address, type, trainerIDInt);

                    ...
                    <div class="form-container">
                        ...
                        <form action="formappointment" method="POST" id="myForm">
                            <div class="content">
                                ...
                                <div class="row">
                                    <input type="email" name="gmail" placeholder="Your email address" required />
                                </div>
                                <div class="row">
                            ...
                            <div class="row">
                                <input type="date"
                                       ...
                                       max=""
                                       required>
                                <span id="dateError" style="color: red; display: none;">Invalid date range. Start date must be current day and end date must be within 30 days.</span>
                            ...
                            <input type="hidden" name="DateSubmit" id="DateSubmitInput" value="">`
                            <!-- Validate Current Date --->

                            <input type="hidden" name="DateSubmit" value="">
...
//                      change this to set in the database
        ...
        <script>
            ...
            // Calculate the maximum date (min + 30 days)
            var maxDate = new Date(today.getTime() + (30 * 24 * 60 * 60 * 1000));
            var maxYear = maxDate.getFullYear();
            var maxMonth = (maxDate.getMonth() + 1).toString().padStart(2, '0');
            var maxDay = maxDate.getDate().toString().padStart(2, '0');

            // Set the maximum date of the input field
            startDateInput.max = maxYear + '-' + maxMonth + '-' + maxDay;

    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form class="form" action="MainController" method="POST">
                <div class="subform">Username<input type="text" name="txtUsername" value="" placeholder="Username"/></div>
                <div class="subform">Password <input type="password" name="txtPassword" value="" placeholder="Password"/></div>
